...
const contact = () => {
  return (
    <div className='ct ma5 mt6 mb6'>
    
    <div className='ct1'>
    <p className='tc f1'>OUR CONTACT</p>
    <p className='measure-wide mr7 ml3 lh-copy' >
Contact Us Whether you’re looking for nutrition information, 
...
our team is happy to help you find answers.
  ...
  <a class="link dim gray dib br-100 h2 w2 mr3 " href="ww" title="">
  ...
  <div class="mt4">
    <a href="ww" class="f6 link dim gray dib mr3 mr4-ns">Help</a>
    <a href="ww" class="f6 link dim gray dib mr3 mr4-ns">Send feedback</a>
    <a href="ww" class="f6 link dim gray dib mr3 mr4-ns">Privacy</a>
    <a href="ww" class="f6 link dim gray dib">Terms</a>
  </div>
</footer>
  
    </div>
    <div className='ct2 ml4'>
    <img src={cont} alt='pp' />
